...
\textcolor{red}{If the programs are simple like the running examples, we can transform left associative compositions to right associative. However, this is not always possible. For example, let us consider a BX 'reverse' program, $breverse$. $breverse$ is constructed by application of $bfoldr$ (the actual program is shown in Section 2) and $bsnoc$. 
