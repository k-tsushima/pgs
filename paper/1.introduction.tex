...
\textcolor{red}{Here, complements are minimal parts that are needed to evaluate $put$. 
  In the middle $put$ and $get$ of Figure \ref{fig:eval-comp-phead-2},
  we use $i_1$, $[[1,2],[3]]$ and $i_2'$, $[100,2]$ to obtain the updated source $[[100,2],[3]]$. However, $[1,2]$ is simpley replaced by $[100,2]$ and not used to coustruct the result. In this case we can use $[..., [3]]$ as a complement.}
