...
\minusvspace
\begin{align}
get_{bx_1 \circ bx_2}~s &= get_{bx_2} (get_{bx_1}~s) \AlignFootnote{Note that the order of composition is the reverse order compared to function composition. We use this order, because it is standard in BX community.}\\
...
\textcolor{red}{TODO-B3,C1: add explanation of complements.}
