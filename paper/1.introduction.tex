...
\noindent
\textcolor{red}{Unlike function composition, the composition of bidirectional programs is read left-to-right. We use this order because it is standard in the BX community.}
