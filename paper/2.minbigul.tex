...
We define the semantics of $put$ and $get$ as in definitions 1 and 2 respectively. Instead of using $v'$ in the $put$ direction like figures \ref{fig:eval-phead}, \ref{fig:eval-comp-phead} and \ref{fig:eval-comp-phead-2}, we just simply use notation $v$ as the updated view. The later definitions also use this convention.
