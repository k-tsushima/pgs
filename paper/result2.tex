...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \begin{groupplot}[
            ...
            \nextgroupplot[ 
                title = {\textit{lcomp-phead}}, 
                legend style = {legend to name = legendgroup,},
                scaled x ticks = {base 10:-5},
                scaled y ticks = {base 10:-2},
            ]
                \pgfplotstableread[col sep=comma]{csv2/lcomp-phead.csv}\data
            ...
            \nextgroupplot[
                title = {\textit{rcomp-ptail}},
                scaled x ticks = {base 10:-5},
                scaled y ticks = {base 10:0},
            ]
                \qaddplot{rcomp-ptail};
            ...
            \nextgroupplot[
                title = {\textit{rcomp-ptail-ldata}},
                scaled x ticks = {base 10:-5},
                scaled y ticks = {base 10:-1},
            ] 
                \qaddplot{rcomp-ptail-ldata};
            ...
            \nextgroupplot[
                title = {\textit{rcomp-bsnoc}},
                scaled x ticks = {base 10:-4},
                scaled y ticks = {base 10:-2},
            ]
                \qaddplot{rcomp-bsnoc};
            ...
            \nextgroupplot[
                title = {\textit{rcomp-bsnoc-ldata}},
                scaled x ticks = {base 10:-4},
                scaled y ticks = {base 10:-2},
            ] 
                \qaddplot{rcomp-bsnoc-ldata};
