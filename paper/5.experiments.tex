...
\textcolor{red}{Note that this result concerns BX programs that uses many compositions. If the number of compositions is small, the original $put$ withoug any memoization will be fastest because of the overhead for memoization ($put_m$) and the overhead for keeping complements in closures ($xpg$).}
