...
Third is introducing type systems to datatype of sources and view. If we introduce this, we can avoid runtime errors like statically-typed functional languages. We need to investigate more about $construct\_dummy$, because current definition that is used in Section~\ref{sect:experiments} will cause type errors. 
