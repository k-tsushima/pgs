...
From the experimental results of left associative composition of BX programs, we know that $put_m$ is fastest method if input size is not very big and $xpg$ is fastest for other left associative programs.
...
We will continue our work on the following points.
First is overcomming our limitation in $xpg$. In $xpg$, there are several limitations: only very-well-behaved programs, path problem (shown in Section ..). To be a practical evlauation method, extention is needed. After extention of the language, we can evaluate more interesting programs for experimental results.

Second is analysis about BX programs and inputs to choose the best evaluation method automatically.
