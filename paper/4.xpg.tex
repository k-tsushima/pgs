...
These two functions are evaluated in $\kpginline{Skip}$ and $\kpginline{Case}$ by applications of $lks \ s$ and $lkv \ v$. At the same time, the third arguments and fourth arguments of recursive calls are updated with the identity functions.
