...
When evaluating $\kpginline{bx_1 \circ bx_2}$, $\underline{ks_1'}$ and $\underline{s_1}$ in the result of the first assignment are still redundant but they are not evaluated.
