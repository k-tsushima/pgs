...
%
The values of these $pg$ functions are the values of final expressions respectively. We only use the return keyword to express explicitly the evaluated value of a function in the situation of $Case$.
