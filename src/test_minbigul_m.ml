...
let put_m_lassoc_comp_bsnoc_ldata n =
  let s = make_list_of_binary_tree n in 
  let v = s in 
  let s' = put_m (lassoc_comp bsnoc_def n) s v [] in 
  s'

let put_m_rassoc_comp_bsnoc_ldata n =
  let s = make_list_of_binary_tree n in 
  let v = s in 
  let s' = put_m (rassoc_comp bsnoc_def n) s v [] in 
  s'

let put_m_lassoc_comp_ptail_ldata n =
  let s = make_list_of_binary_tree (n + 1) in 
  let v = make_list 1 10 in 
  let s' = put_m (lassoc_comp ptail n) s v [] in 
  s'

let put_m_rassoc_comp_ptail_ldata n =
  let s = make_list_of_binary_tree (n + 1) in 
  let v = make_list 1 10 in 
  let s' = put_m (rassoc_comp ptail n) s v [] in 
  s'

let put_m_lassoc_comp_replace_ldata n =
  let s = make_list_of_binary_tree n in 
  let v = make_list_of_binary_tree n in 
  let s' = put_m (lassoc_comp Replace n) s v [] in 
  s'

let put_m_rassoc_comp_replace_ldata n =
  let s = make_list_of_binary_tree n in 
  let v = make_list_of_binary_tree n in 
  let s' = put_m (rassoc_comp Replace n) s v [] in 
  s'

let put_m_breverse_ldata n =
  let s = make_list_of_binary_tree n in
  let v = s in 
  let s' = put_m breverse s v [] in 
  s'

let put_m_bmapreplace_ldata n =
  let s = make_list_of_binary_tree n in
  let v = s in 
  let s' = put_m bmapreplace s v [] in 
  s'

let put_m_rassoc_comp_breverse_ldata n = 
  let s = make_list_of_binary_tree n in 
  let v = s in 
  let s' = put_m (rassoc_comp breverse n) s v [] in 
  s'